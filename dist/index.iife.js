var gridfs_extra = (function (exports, mongodb) {
    'use strict';
    ...
    function createGridFSBucket(db, options) {
        return new mongodb__namespace.GridFSBucket(db, options);
    }
    /**
    ...
    exports.createGridFSBucket = createGridFSBucket;
    exports.readFileById = readFileById;
    exports.readFileByName = readFileByName;
    exports.readFileWithStream = readFileWithStream;
    exports.writeFileById = writeFileById;
    exports.writeFileByName = writeFileByName;
